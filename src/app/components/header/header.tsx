...
export default ({onOpenForm, buttonCaption = 'Добавить'}: Props) => {
    ...
    return (
        <div className={css.top_panel}>
            <div>
                <img src={Logo} className={css.logo} alt="MoySklad App"/>
            </div>
            <div>
                <button className={css.add_button} onClick={openFormHandler} type="button" data-modal-target="contragents-modal" data-modal-toggle="contragents-modal">
                    <svg className={css.add_button_icon} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
